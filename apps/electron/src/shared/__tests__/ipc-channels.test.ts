...
const EXPECTED_CHANNELS: string[] = [
  ...
  'plugins:enable',
  'plugins:get',
  'plugins:invokeComposerAction',
  'plugins:invokeSessionAction',
  'plugins:list',
  'plugins:listCapabilities',
  'plugins:listChatCardTypes',
  'plugins:listComposerActions',
  'plugins:listRoutes',
  'plugins:listSessionActions',
  'plugins:listSettingsPanes',
  'power:getKeepAwake',
  'power:setKeepAwake',
  'preferences:read',
  'preferences:write',
